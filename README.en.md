...
The current release is **0.1.0 preview**, installed by building from source. See the [installation guide](docs/INSTALL.md) for dependencies, installation, updates and migration. You do not need to install Voxtype separately or download a local speech model.
