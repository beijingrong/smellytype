...
// SmellyType Quickshell theme singleton.
//
...
QtObject {
    ...
    /// Recording-state indicator color. SmellyType's signature
    ...
    /// swayosd so smellytype's OSD blends with the rest of an Omarchy
