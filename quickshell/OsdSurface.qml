// SmellyType on-screen display surface (Quickshell frontend).
//
...
PanelWindow {
    ...
    WlrLayershell.namespace: "smellytype-osd"
    ...
    Loader {
        ...
        onStatusChanged: {
            if (status === Loader.Error) {
                console.warn("smellytype OSD: failed to load custom QML, falling back to built-in surface:", source);
