...
fn generate_config(hotkey: &str, toggle: bool) -> String {
    ...
    format!(
        r#"-- SmellyType Hammerspoon Integration
...
/// Install the smellytype.lua module to ~/.hammerspoon/
async fn install_module() -> anyhow::Result<()> {
    ...
    // Write the smellytype.lua module
    let module_path = hs_dir.join("smellytype.lua");
    let module_content = include_str!("../../contrib/hammerspoon/smellytype.lua");
...
pub async fn run(install: bool, show: bool, hotkey: &str, toggle: bool) -> anyhow::Result<()> {
    println!("Hammerspoon Integration for SmellyType");
    println!("====================================\n");
    ...
    if install {
        ...
        println!("  smellytype setup hammerspoon --install");
        println!("      Install smellytype.lua module and show config snippet\n");
        println!("  smellytype setup hammerspoon --show");
        println!("      Show the init.lua configuration snippet\n");
        println!("  smellytype setup hammerspoon --install --hotkey rightcmd");
        println!("      Install with a different hotkey\n");
        println!("  smellytype setup hammerspoon --install --toggle");
