...
/// Top-level error type for the smellytype application
#[derive(Error, Debug)]
pub enum SmellyTypeError {
...
pub enum TranscribeError {
    #[error("Model not found: {0}\n  Run 'smellytype setup' to download models.")]
...
#[derive(Error, Debug)]
pub enum VadError {
    #[error("VAD model not found: {0}\n  Run 'smellytype setup vad' to download.")]
    ModelNotFound(String),
...
/// Result type alias using SmellyTypeError
pub type Result<T> = std::result::Result<T, SmellyTypeError>;
