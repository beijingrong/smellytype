// Command-line interface definitions for smellytype
//
...
pub const ENGINE_NAMES_CSV: &str =
    "whisper, parakeet, moonshine, sensevoice, paraformer, dolphin, omnilingual, cohere, openvino, soniox, doubao";
...
/// Values `smellytype setup --progress-format` accepts. `human` is curl's
