...
pub enum Commands {
    ...
    /// Launch daemon + menubar (used by SmellyType.app bundle)
    #[cfg(target_os = "macos")]
    #[command(hide = true)]
    AppLaunch,
    ...
    Setup {
        ...
        /// `smellytype config set <engine>.model <NAME>`.
        #[arg(long)]
        activate: bool,
        ...
        #[arg(
            ...
            env = "SMELLYTYPE_PROGRESS_FORMAT",
        )]
    ...
    ///
    /// With no subcommand, prints the resolved configuration. Use `smellytype
