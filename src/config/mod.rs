//! Configuration loading and types for smellytype
//!
//! Configuration is loaded in layers:
//! 1. Built-in defaults
//! 2. Config file (~/.config/smellytype/config.toml)
//! 3. Environment variables (SMELLYTYPE_*)
...
pub use engines::{
    CohereConfig, DolphinConfig, DoubaoConfig, MoonshineConfig, OmnilingualConfig, OpenVinoConfig,
