...
//! (default `$XDG_RUNTIME_DIR/smellytype/audio.sock`). This module encapsulates:
//!
...
//!
//! The design goal is that the two frontends (`smellytype-osd-native` and
//! `smellytype-osd-gtk4`) can share an identical IPC surface and only differ
