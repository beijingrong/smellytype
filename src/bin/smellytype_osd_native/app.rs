//! Wayland + wgpu + egui-wgpu glue for `smellytype-osd-native`.
//!
...
use smellytype::audio::levels::AudioFrame;
use smellytype::osd::config::{OsdConfig, OsdPosition};
use smellytype::osd::ipc::FrameRing;
...
impl App {
    ...
    fn create_surface(&mut self) -> anyhow::Result<()> {
        ...
        let (device, queue) = pollster::block_on(adapter.request_device(&wgpu::DeviceDescriptor {
            label: Some("smellytype-osd-device"),
    ...
    fn render_frame(&mut self) -> anyhow::Result<()> {
        ...
        let envelope_cols = {
            ...
            let frames_in_window =
                (waveform_window_secs * smellytype::audio::levels::FRAME_HZ as f32) as usize;
        ...
        let mut encoder = rs
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("smellytype-osd-encoder"),
            });
...

        {
            ...
            let mut rpass = encoder
                .begin_render_pass(&wgpu::RenderPassDescriptor {
                    label: Some("smellytype-osd-pass"),
...
fn color_to_egui(c: smellytype::osd::visual::Color) -> egui::Color32 {
